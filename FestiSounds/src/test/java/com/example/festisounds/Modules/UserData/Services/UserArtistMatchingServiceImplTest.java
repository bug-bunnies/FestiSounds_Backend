...
class UserArtistMatchingServiceImplTest {
    ...
    public static Stream<Arguments> artistScoreParameters() {
        ...
        return Stream.of(
                Arguments.of(96.0, new ArrayList<>(Arrays.asList(90.0, 80.0, 70.0))),
                Arguments.of(70.25, new ArrayList<>(Arrays.asList(50.0, 30.0, 15.0))),
                Arguments.of(93.0, new ArrayList<>(Arrays.asList(87.4, 34.8, 93))),
                Arguments.of(96.0, new ArrayList<>(Arrays.asList(93.0, 2.0))),
