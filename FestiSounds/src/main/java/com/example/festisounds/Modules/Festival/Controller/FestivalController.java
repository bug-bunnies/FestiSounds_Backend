...
// TODO: Validate path variable
    ...
    public ResponseEntity<FestivalResponseDTO[]> searchFestivalsByName(@Valid @RequestParam("festivalName") String festivalName) {
        try {
    ...
    public ResponseEntity<FestivalResponseDTO> createFestival(@Valid @RequestBody FestivalRequestDTO festival) {
